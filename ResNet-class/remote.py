...
data_root = os.getcwd()
image_path = data_root + "/remoteimg/"  # flower data set path
...
#net.eval())
#missing_keys, unexpected_keys = net.load_state_dict(torch.load(model_weight_path))
missing_keys, unexpected_keys = net.load_state_dict(torch.load(model_weight_path), strict=False)#载入模型参数
#missing_keys, unexpected_keys = net
# for param in net.parameters():
#     param.requires_grad = False
# change fc layer structure

inchannel = net.fc.in_features
net.fc = nn.Linear(inchannel, 1000)
